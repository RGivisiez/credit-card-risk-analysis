...
O notebook é melhor visualizado usando o Gooble Colab ([link](https://colab.research.google.com/github/RGivisiez/credit-card-risk-analysis/blob/main/Default_risk_Nubank_dataset.ipynb)).
